...
public class BluePiece extends Piece {
	...
	public BluePiece(Board board) {
		super(Color.BLUE, board);
		_board = board;
		_blocks = super.getBlocks();
		_blocks[0].setLocation(5 * Constants.BLOCK_SIZE, 2 * Constants.BLOCK_SIZE);
		_blocks[1].setLocation(6 * Constants.BLOCK_SIZE, 2 * Constants.BLOCK_SIZE);
