 ...
 *
 */
public class CyanPiece extends Piece {
	
	private Board _board;
	private RectangleShape[] _blocks;
	
	public CyanPiece(Board board) {
		super(Color.CYAN, board);
		_board = board;
		...
		_blocks[2].setLocation(6 * Constants.BLOCK_SIZE, 2 * Constants.BLOCK_SIZE);
		_blocks[3].setLocation(7 * Constants.BLOCK_SIZE, 2 * Constants.BLOCK_SIZE);
	}
